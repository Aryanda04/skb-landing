    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row justify-between">
          ...
          <div className="md:w-1/3 mb-8 md:mb-0">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-2xl font-bold">SKB Belitung</h3>
            </div>
            ...
            <p className="text-gray-400">
              Kami hadir sebagai jembatan pendidikan bagi seluruh masyarakat,
              terutama bagi mereka yang perjalanannya di sekolah formal
              terputus. Mewujudkan masyarakat yang cerdas, terampil, dan
              berakhlak mulia.
            </p>
          </div>
          ...
          <div className="md:w-1/4 mb-8 md:mb-0">
            ...
            <ul className="space-y-4 text-gray-400">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span>skbbelitung2@gmail.com</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg
                  className="w-5 h-5 flex-shrink-0"
          ...
          <div className="md:w-1/6">
            ...
            <div className="flex space-x-4">
              <Link
                href="https://web.facebook.com/profile.php?id=100075041155065"
        ...
        <div className="border-t border-gray-800 mt-4 pt-4 text-center text-gray-400">
          <p>
            &copy; {new Date().getFullYear()} UPT SPNF SKB Belitung. All rights
            reserved.
          </p>
        </div>
      </div>
